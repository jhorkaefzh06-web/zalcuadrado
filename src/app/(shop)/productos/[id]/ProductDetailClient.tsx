        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-3 pt-2">
              {/* Quantity Selector */}
              <div className="flex items-center justify-between bg-brand-900/60 border border-slate-700 rounded-2xl px-4 py-3 sm:w-32 shrink-0">
                <button
                ...
                <span className="text-white font-bold text-sm select-none w-8 text-center">{qty}</span>
                <button
            ...
            <div className="pt-1">
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-xs font-semibold text-emerald-400 border border-emerald-500/30 hover:bg-emerald-500/10 hover:text-emerald-300 transition-all cursor-pointer"
              >
